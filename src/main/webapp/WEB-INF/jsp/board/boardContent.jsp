...
function showReplyList(){
	...
	var paramData = {"seq" : "${boardContent.seq}"};
	$.ajax({
		type: 'POST',
		url: url,
		data: paramData,
		...
		<div class="container" role="main">
			...
			<div class="bg-white rounded shadow-sm">
				...
				<div class="board_info_box">
					<span class="board_author"><c:out value="${boardContent.name}"/>,</span><span class="board_date"><c:out value="${boardContent.regdate}"/></span>
				</div>
				<div class="board_content">${boardContent.content}</div>
				<div class="board_tag">TAG : <c:out value="${boardContent.content}"/></div>
			</div>
